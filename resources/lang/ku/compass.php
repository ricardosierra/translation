...
return [
    'welcome'                => 'بەخێربێیت بۆ قیبلەنمای ڤۆیەیجەر (Facilitador). هەموو ئەپڵیکەیشنێک پێویستی بە قیبلەنمایەکە بۆ نیشاندانی ڕێی ڕاست.
    ...
    'links'         => [
        ...
        'facilitador_homepage'      => 'پەڕەی سەرەتای ڤۆیەیجەر (Facilitador)',
        'facilitador_hooks'         => 'هووکەکانی ڤۆیەیجەر (Facilitador)',
    ],
    'commands'      => [
        'title'                 => 'ناونیشان',
