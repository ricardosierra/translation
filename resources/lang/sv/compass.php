...
return [
    'welcome'           => 'Välkommen till Facilitador Compass. Alla bra appar behöver in kompass som visar riktningen.
    I denna avdelning hittar du resurser som hjälper dig att bygga din applikation',
    'links' => [
        'title'                 => 'Länkar',
        'documentation'         => 'Dokumentation',
        'facilitador_homepage'      => 'Facilitador Hemsida',
        'facilitador_hooks'         => 'Facilitador Hooks',
    ],
    'commands' => [
        'title'                 => 'Kommandon',
        'text'                  => 'Kör Artisan Kommandon från Facilitador.',
    ...
    'resources' => [
        'title'                 => 'Resurser',
        'text'                  => 'Facilitador resurser som hjälper dig hitta snabbare.',
    ],
    'logs' => [
        'title'                 => 'Loggar',
    ...
    'fonts' => [
        'title'                 => 'Typsnitt',
        'font_class'            => 'Facilitador Typsnitt Klasser',
        'font_character'        => 'Facilitador Typsnitt Tecken',
    ],
];
